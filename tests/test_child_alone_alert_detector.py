"""Tests for Exercise 3 (and its follow-up) — see README.md."""

from camera_events import DetectionEvent, should_open_child_alone_alert


# ---------------------------------------------------------------------
# Exercise 3 — two-argument version
# ---------------------------------------------------------------------


def test_ex3_opens_when_window_reached():
    events = [
...
def test_ex3_adult_breaks_window():
    events = [
        DetectionEvent(1000, 0, 1),
...
def test_ex3_duplicate_timestamp_keeps_last_input_event():
    events = [
        DetectionEvent(1000, 0, 1),
        DetectionEvent(2000, 0, 1),
        DetectionEvent(2000, 1, 1),
...
def test_ex3_handles_unordered_input():
    events = [
        DetectionEvent(3000, 0, 1),
        DetectionEvent(1000, 0, 1),
        DetectionEvent(2000, 0, 1),
...
def test_ex3_no_child_breaks_window():
    events = [
        DetectionEvent(1000, 0, 1),
...
def test_ex3_edge_cases_return_false():
    ok = [
        DetectionEvent(1000, 0, 1),
        DetectionEvent(3000, 0, 1),
    ]
...
# ---------------------------------------------------------------------
# Exercise 3 — follow-up with late_tolerance_millis
# ---------------------------------------------------------------------


def test_ex3_followup_large_gap_resets_window():
    events = [
        DetectionEvent(1000, 0, 1),
...
def test_ex3_followup_within_tolerance_opens():
    events = [
        DetectionEvent(1000, 0, 1),
        DetectionEvent(2000, 0, 1),
        DetectionEvent(3000, 0, 1),
...
def test_ex3_followup_negative_tolerance_returns_false():
    events = [
        DetectionEvent(1000, 0, 1),
        DetectionEvent(3000, 0, 1),
    ]
